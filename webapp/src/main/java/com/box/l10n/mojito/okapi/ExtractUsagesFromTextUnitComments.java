...
public class ExtractUsagesFromTextUnitComments {
     ...
     */
    protected Set<String> extractUsagesFromTextUnit(TextUnit textUnit) {
     ...
     */
    private void removeUsagesFromTextUnitComment(TextUnit textUnit) {
        String comment = textUnitUtils.getNote(textUnit);
     ...
     * @return the locations or empty set
     */
    protected Set<String> getUsagesFromTextUnitComments(String comment) {
